...
public class USJKPSPublicSoap
{
    ...
    public USJKPSPublicSoap(){}

    public USJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public USJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        USJExtendedSoapSerializationEnvelope envelope= new USJExtendedSoapSerializationEnvelope(USJExtendedSoapSerializationEnvelope.VER11);
