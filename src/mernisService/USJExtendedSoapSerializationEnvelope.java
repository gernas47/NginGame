...
public class USJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(USJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new USJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static USJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static USJDateTimeConverter dateTimeConverter = new USJStandardDateTimeConverter();

    public USJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public USJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new USJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=USJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,USJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=USJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
